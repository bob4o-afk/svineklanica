...
from ..spheres import CATEGORY_REFERENCE, SPHERE_HEALTHCARE
...
class NcprSource(Source):
    ...
    def _row_to_record(self, row, colmap, payload, idx) -> IngestRecord | None:
        ...
        canonical = CanonicalPayload(
            ...
            title=product,
            # Reference benchmark (drug ceiling prices) — feeds the overpricing
            # detector as a comparison baseline, not itself a flagged record.
            inn=col("inn"),
            product=product,
